...
#   Vectores con las distintas frecuencias y su ganancia del filtro implementado
freqPrueba = [5, 10, 15, 20, 25, 30, 35, 40, 45, 50, 55, 60, 65, 70, 80, 90, 100]
amplitudPrueba = [0, 0, 0, -0.0168, -0.340, -1.85, -3.69, -14.3, -18.75, -22.6, -24.7,-28, -29.45, -31.4, -34.3,-35.8, -38.75]
...
f1, h_sim_1, _ = import_AC_LTSpice('Analisis_Frecuencial_SallenKey_SECCION1.txt')
f2, h_sim_2, _ = import_AC_LTSpice('Analisis_Frecuencial_SallenKey_SECCION2.txt')
...
ax3_big.plot(freqPrueba, amplitudPrueba, label='Implementado')
...
#plt.plot(freqPrueba, amplitudPrueba, label='Implementado')
